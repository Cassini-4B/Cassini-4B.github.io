...
There is now more randomness to the residuals plot, and the regressor did seem to improve, giving RSME scores of 0.92 and R-squared scores of 0.39 for the test sets.  The predicted vs actuals show a more linear relationship, 

![alt_text](/pics/xkcd_linreg.png)
But alas, instead of a wonderful linear regression model with a magical formula showing you the secrets of how to maximize your NSF grant funding, I leave you with a new constellation: the Monty Hall Goat!  
